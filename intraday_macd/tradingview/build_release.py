...
//
//  【本版關鍵參數 — 目標: 在 2 個交易日窗口內, 盡量捕獲期內最大昇幅】
//   ★ 回測期間全部在 Inputs ① 設定, 不用改程式碼: 方式 A 最近 N 個交易日 (預設 2, 跳週六日) / 方式 B 最近 N 天 (日曆) / 方式 C 指定開始與結束日期
...
//  預設: 本金 100,000 · 最近 2 個交易日 · 美股時段 09:30-16:00 America/New_York (DST 自動) · 15:45 後不開新倉 · 15:58 強制平倉
