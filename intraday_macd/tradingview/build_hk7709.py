...
hdr = rep(hdr, 'EOD (15:58 強平) / 午休 (11:58 午休前平倉, ⑤ 可選, 預設關) / SL (止損) / 窗口結束', 'EOD (15:58 強平; 半日市 11:58) / 午休 (11:58 午休前平倉, ⑤ 可選, 預設關) / 韓股收市 (14:30, ⑤ 可選, 預設關) / SL (止損) / 追蹤止損 · 止賺 (自動調參選到該出場模式時) / 隔夜備援 (留倉到翌日第一根平掉) / 窗口結束')
