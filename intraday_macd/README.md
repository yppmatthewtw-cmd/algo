...
這裡沒有 7709 的行情資料 (行情主機全部不通), 所以平均化在 TradingView 圖上做: `tradingview/hk7709_pattern_src.pine` → `build_hk7709_pattern.py` 產出 `HK7709-mode5_1month-pattern(09月23日; 09.31).pine` (317 行, 純顯示副圖, 不參與四模式買賣)。
